 ...
 */
public class TestPaperOptionDO implements Serializable {
	 ...
	 * 设置：试题选项
	 */
	public void setTestPaperOption(String testPaperOption) {
		this.testPaperOption = testPaperOption;
	}
	/**
	 * 获取：试题选项
	 */
	public String getTestPaperOption() {
		return testPaperOption;
	}
	/**
	 * 设置：试题题目id
	 */
