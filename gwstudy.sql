/*
 ...
 Source Schema         : gwstudy

 Target Server Type    : MySQL
 Target Server Version : 50724
 File Encoding         : 65001

 Date: 23/03/2019 11:37:41
*/
...
-- ----------------------------
-- Table structure for exercise_test_paper_answer
-- ----------------------------
DROP TABLE IF EXISTS `exercise_test_paper_answer`;
CREATE TABLE `exercise_test_paper_answer`  (
  `id` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `operator` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `createdate` datetime(0) NOT NULL,
  `modifydate` datetime(0) NOT NULL,
  `test_paper_answer` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '试题选项',
  `test_paper_topic_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '试题题目id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci COMMENT = '试题答案表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for exercise_test_paper_option
-- ----------------------------
DROP TABLE IF EXISTS `exercise_test_paper_option`;
CREATE TABLE `exercise_test_paper_option`  (
  `id` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `operator` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `createdate` datetime(0) NOT NULL,
  `modifydate` datetime(0) NOT NULL,
  `test_paper_option` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '试题选项',
  `test_paper_topic_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '试题题目id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci COMMENT = '试题选项表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for exercise_test_paper_topic
-- ----------------------------
DROP TABLE IF EXISTS `exercise_test_paper_topic`;
CREATE TABLE `exercise_test_paper_topic`  (
  `id` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `operator` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `createdate` datetime(0) NOT NULL,
  `modifydate` datetime(0) NOT NULL,
  `test_paper_topic` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '试题题目',
  `test_paper_type_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '试题类型id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci COMMENT = '试题题目表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for exercise_test_paper_type
-- ----------------------------
DROP TABLE IF EXISTS `exercise_test_paper_type`;
CREATE TABLE `exercise_test_paper_type`  (
  `id` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `operator` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `createdate` datetime(0) NOT NULL,
  `modifydate` datetime(0) NOT NULL,
  `exercise_title` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '试卷题目',
  `exercise_type` varchar(4) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '试题类型(01选择题（单选），02填空题，03判断题，04主观题)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci COMMENT = '试卷表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for front_fro_user
-- ----------------------------
DROP TABLE IF EXISTS `front_fro_user`;
CREATE TABLE `front_fro_user`  (
  `id` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `operator` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `createdate` datetime(0) NOT NULL,
  `modifydate` datetime(0) NOT NULL,
  `user_no` varchar(40) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '前端用户编码(系统生成)',
  `user_name` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '前端用户姓名',
  ...
  `head_portrait` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '头像',
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '家庭住址',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci COMMENT = '前端用户表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 378 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for sys_max_no
-- ----------------------------
DROP TABLE IF EXISTS `sys_max_no`;
CREATE TABLE `sys_max_no`  (
  `id` varchar(32) CHARACTER SET latin1 COLLATE latin1_bin NOT NULL,
  `operator` varchar(32) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `createdate` datetime(0) NOT NULL,
  `modifydate` datetime(0) NOT NULL,
  `code_key` varchar(40) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL COMMENT '关键key',
  `code_value` int(40) NOT NULL COMMENT '关键value',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci COMMENT = '系统最大号表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 113 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单管理' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3577 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色与菜单对应关系' ROW_FORMAT = Dynamic;
